...
const translations = {
  en: {
    ...
    choose_build: 'Choose build from Git',
    load_builds: 'Load builds',
    loading_builds: 'Loading builds...',
    select_build: 'Select a release to install',
    no_builds: 'No releases with APK found',
    install_build: 'Install',
    installing_build: 'Installing...',
    ...
    bug_chat_open: 'Report a bug',
    bug_chat_title: 'Bug Chat',
    bug_chat_close: 'Close bug chat',
    bug_chat_empty: 'No bug messages yet',
    bug_chat_placeholder: 'Describe what happened and how to reproduce it...',
    bug_chat_attach: 'Attach image',
    bug_chat_send: 'Send',
    bug_chat_status_queued: 'Queued',
    bug_chat_status_sending: 'Sending',
    bug_chat_status_sent: 'Sent',
    bug_chat_status_error: 'Error',
    bug_chat_retry: 'Retry',
    bug_chat_reattach: 'Choose file again',
    bug_chat_preview_unavailable: 'Preview unavailable after app restart',
  },
  ru: {
    nav_home: 'Главная',
    nav_chat: 'Общение',
    ...
    choose_build: 'Выбрать сборку из Git',
    load_builds: 'Загрузить сборки',
    loading_builds: 'Загрузка сборок...',
    select_build: 'Выберите релиз для установки',
    no_builds: 'Нет релизов с APK',
    install_build: 'Установить',
    installing_build: 'Установка...',
    language_label: 'Язык',
    ...
    bug_chat_open: 'Сообщить о баге',
    bug_chat_title: 'Bug Chat',
    bug_chat_close: 'Закрыть окно Bug Chat',
    bug_chat_empty: 'Пока нет сообщений о багах',
    bug_chat_placeholder: 'Опишите проблему и шаги для повторения...',
    bug_chat_attach: 'Прикрепить изображение',
    bug_chat_send: 'Отправить',
    bug_chat_status_queued: 'В очереди',
    bug_chat_status_sending: 'Отправка',
    bug_chat_status_sent: 'Отправлено',
    bug_chat_status_error: 'Ошибка',
    bug_chat_retry: 'Повторить',
    bug_chat_reattach: 'Выбрать файл заново',
    bug_chat_preview_unavailable: 'Превью недоступно после перезапуска приложения',
  },
} as const;
